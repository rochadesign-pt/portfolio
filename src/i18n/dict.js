...
export const dict = {
  pt: {
    ...
    contactPage: {
      ...
      formName: 'Nome',
      formEmail: 'Email',
      formCompany: 'Empresa / marca (opcional)',
      formType: 'Tipo de projeto',
      formBudget: 'Orçamento',
      formTimeline: 'Prazo',
      formMessage: 'Conta-nos sobre o projeto',
      selectPlaceholder: 'Seleciona…',
      typeOptions: ['Branding & Identidade', 'Web & Digital', 'UI/UX & Produto', 'Vários / ainda não sei'],
      budgetOptions: ['Até 5.000 €', '5.000 – 10.000 €', '10.000 – 25.000 €', 'Mais de 25.000 €', 'Ainda não sei'],
      timelineOptions: ['O quanto antes', '1–3 meses', '3–6 meses', 'Sem pressa / a explorar'],
  ...
  en: {
    ...
    contactPage: {
      ...
      formName: 'Name',
      formEmail: 'Email',
      formCompany: 'Company / brand (optional)',
      formType: 'Project type',
      formBudget: 'Budget',
      formTimeline: 'Timeline',
      formMessage: 'Tell us about the project',
      selectPlaceholder: 'Select…',
      typeOptions: ['Branding & Identity', 'Web & Digital', 'UI/UX & Product', 'A few / not sure yet'],
      budgetOptions: ['Up to €5,000', '€5,000 – €10,000', '€10,000 – €25,000', 'More than €25,000', 'Not sure yet'],
      timelineOptions: ['ASAP', '1–3 months', '3–6 months', 'No rush / exploring'],
