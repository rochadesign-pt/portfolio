...
export const dict = {
  pt: {
    ...
    studioPage: {
      ...
      sub: 'Fundado em 2025. Um estúdio independente de branding, web e produto digital.',
      ...
      origin: {
        ...
        worldAccent: 'mundo inteiro.',
        place: 'Ílhavo · Portugal',
        coords: '40.6035° N, 8.6704° W',
        hint: 'Faz scroll',
      },
      placeLabel: 'O nosso quintal',
      placeTitle: 'Feito à',
      placeAccent: 'beira-Ria.',
      placeBody:
        'Ílhavo, no coração da Ria de Aveiro. Uma cidade pequena que nos ensinou o valor do detalhe e do trabalho bem feito — e é daqui que trabalhamos para o mundo.',
      placeCaption: 'Ílhavo · Portugal',
      spaceCaption: 'O estúdio',
      detailCaption: 'Ao pormenor',
      workLabel: 'Trabalho selecionado',
      workTitle: 'A prova está no',
      workTitleAccent: 'trabalho.',
      workCta: 'Ver todo o trabalho',
    },
    behind: {
      label: 'Por dentro',
    ...
    contactPage: {
      ...
      phName: 'Nome',
      phEmail: 'Email',
      phCompany: 'Empresa / marca (opcional)',
      helpLabel: 'Serviços',
      helpOptions: ['Branding & Identidade', 'UI/UX Design', 'Web Design', 'Desenvolvimento No-Code'],
      budgetLabel: 'Orçamento',
      budgetOptions: ['Até 5.000 €', '5.000 – 10.000 €', '10.000 – 25.000 €', 'Mais de 25.000 €', 'Ainda não sei'],
      foundLabel: 'Como nos encontraste',
      foundOptions: ['Google', 'Instagram', 'Behance', 'LinkedIn', 'Recomendação', 'Outro'],
      selectPlaceholder: 'Seleciona…',
      phMessage: 'Conta-nos sobre o projeto',
      ...
      brief: {
        eyebrow: 'Brief assistido',
        cta: 'Constrói o teu brief',
        hint: 'Responde a 4 perguntas e preenchemos o formulário por ti.',
        step: 'Passo',
        of: 'de',
        back: 'Voltar',
        next: 'Seguinte',
        apply: 'Preencher formulário',
        skip: 'Prefiro escrever',
        q1: 'Em que precisas de ajuda?',
        q2: 'Que orçamento tens em mente?',
        q3: 'Para quando?',
        q4: 'Descreve o projeto numa frase.',
        q4ph: 'Ex.: rebranding + site para uma marca de café de especialidade.',
        timelineOptions: ['O quanto antes', 'Nos próximos 1–3 meses', 'Daqui a 3+ meses', 'Ainda a explorar'],
        scopeLabel: 'Âmbito',
        timelineLabel: 'Timeline ideal',
      },
    },
  },
  en: {
    ...
    studioPage: {
      ...
      sub: 'Founded in 2025. An independent studio for branding, web and digital product.',
      ...
      origin: {
        ...
        worldAccent: 'whole world.',
        place: 'Ílhavo · Portugal',
        coords: '40.6035° N, 8.6704° W',
        hint: 'Scroll',
      },
      placeLabel: 'Our backyard',
      placeTitle: 'Made by the',
      placeAccent: 'water.',
      placeBody:
        'Ílhavo, on the edge of the Ria de Aveiro lagoon. A small town that taught us the value of detail and work done right — and it is from here that we work with the world.',
      placeCaption: 'Ílhavo · Portugal',
      spaceCaption: 'The studio',
      detailCaption: 'In the detail',
      workLabel: 'Selected work',
      workTitle: 'The proof is in the',
      workTitleAccent: 'work.',
    ...
    contactPage: {
      ...
      phName: 'Name',
      phEmail: 'Email',
      phCompany: 'Company / brand (optional)',
      helpLabel: 'Services',
      helpOptions: ['Brand Identity', 'UI/UX Design', 'Web Design', 'No-Code Development'],
      budgetLabel: 'Budget',
      budgetOptions: ['Up to €5,000', '€5,000 – €10,000', '€10,000 – €25,000', 'More than €25,000', 'Not sure yet'],
      foundLabel: 'How did you find us',
      foundOptions: ['Google', 'Instagram', 'Behance', 'LinkedIn', 'Referral', 'Other'],
      selectPlaceholder: 'Select…',
      phMessage: 'Tell us about the project',
      ...
      brief: {
        ...
        hint: 'Answer 4 quick questions and we’ll fill the form for you.',
        step: 'Step',
        of: 'of',
        back: 'Back',
        next: 'Next',
        apply: 'Fill the form',
        skip: 'I’d rather write',
        q1: 'What do you need help with?',
        q2: 'What budget do you have in mind?',
        q3: 'What’s the timing?',
        q4: 'Describe the project in one line.',
        q4ph: 'e.g. rebrand + website for a specialty coffee brand.',
        timelineOptions: ['As soon as possible', 'In the next 1–3 months', '3+ months out', 'Still exploring'],
        scopeLabel: 'Scope',
