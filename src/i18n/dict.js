...
export const dict = {
  pt: {
    ...
    contactPage: {
      ...
      qName: 'Como te chamas?',
      phName: 'O teu nome completo',
      qEmail: 'Qual o melhor email para te contactarmos?',
      phEmail: 'joao@empresa.com',
      qCompany: 'Quem representas?',
      phCompany: 'A tua empresa, startup ou projeto pessoal',
      qHelp: 'Em que te podemos ajudar?',
      helpOptions: ['Branding & Identidade', 'UI/UX Design', 'Web Design', 'Desenvolvimento No-Code'],
      qBudget: 'Qual o orçamento para este projeto?',
      budgetPlaceholder: 'Seleciona orçamento…',
      budgetOptions: ['Até 5.000 €', '5.000 – 10.000 €', '10.000 – 25.000 €', 'Mais de 25.000 €', 'Ainda não sei'],
      qMessage: 'Fala-nos do teu projeto.',
      phMessage: 'O que estás a construir, que problema resolves, e o que é sucesso para ti?',
      qFound: 'Como nos encontraste?',
      foundPlaceholder: 'Seleciona…',
  ...
  en: {
    ...
    contactPage: {
      ...
      qEmail: "What's the best email to reach you?",
      phEmail: 'john@company.com',
      qCompany: 'Who are you representing?',
      phCompany: 'Your company, startup or personal project',
      qHelp: 'What can we help you with?',
      helpOptions: ['Brand Identity', 'UI/UX Design', 'Web Design', 'No-Code Development'],
      qBudget: "What's your budget for this project?",
      budgetPlaceholder: 'Select budget…',
      budgetOptions: ['Up to €5,000', '€5,000 – €10,000', '€10,000 – €25,000', 'More than €25,000', 'Not sure yet'],
      qMessage: 'Tell us about your project.',
      phMessage: "What are you building, what's the problem you're solving, and what does success look like for you?",
      qFound: 'How did you find us?',
      foundPlaceholder: 'Select option…',
